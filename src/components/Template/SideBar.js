...
const SideBar = () => (
  <section id="sidebar">
    ...
    <section className="blurb">
      <h2>About</h2>
      <p> Hi! I&apos;m Jack, a first-year PhD Candidate in Economics at Columbia University. Prior to graduate school, I obtained my B.A. in Economics from the University of Georgia and then spent two enriching years as a Pre-doctoral Research Fellow with the Economics and Computation group at <a href="https://www.microsoft.com/en-us/research/lab/microsoft-research-new-england/"> Microsoft Research</a>.</p>
